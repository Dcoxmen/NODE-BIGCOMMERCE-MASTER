...
router.post("/", async (req, res) => {
  ...
  try {
   ...
   //benefits and features arrays
    ...
    let preUrl = 'https://store-4ccc5gfp0c.mybigcommerce.com/content/datasheet/icons/'
    ...
    if(featArr == 'undefined') {
      ...
      let url1a = (preUrl + prodlineformat + "-"+ axtionSformat + "-" + featArr[0] + ".png").replace(/\s+/g, '-').toLowerCase()
      let url1b = (preUrl + prodlineformat + "-"+ featArr[0] + ".png").replace(/\s+/g, '-').toLowerCase()
      let url2a = (preUrl + prodlineformat + "-"+ axtionSformat + "-" + featArr[1] + ".png").replace(/\s+/g, '-').toLowerCase()
      let url2b = (preUrl + prodlineformat + "-"+ featArr[1] + ".png").replace(/\s+/g, '-').toLowerCase() 
      let url3a = (preUrl + prodlineformat + "-"+ axtionSformat + "-" + featArr[2] + ".png").replace(/\s+/g, '-').toLowerCase()
      let url3b = (preUrl + prodlineformat + "-"+ featArr[2] + ".png").replace(/\s+/g, '-').toLowerCase()
      let url4a = (preUrl + prodlineformat + "-"+ axtionSformat + "-" + featArr[3] + ".png").replace(/\s+/g, '-').toLowerCase()
      let url4b = (preUrl + prodlineformat + "-"+ featArr[3] + ".png").replace(/\s+/g, '-').toLowerCase()
      let url5a = (preUrl + prodlineformat + "-"+ axtionSformat + "-" + featArr[4] + ".png").replace(/\s+/g, '-').toLowerCase()
      let url5b = (preUrl + prodlineformat + "-"+ featArr[4] + ".png").replace(/\s+/g, '-').toLowerCase()
      let url6a = (preUrl + prodlineformat + "-"+ axtionSformat + "-" + featArr[5] + ".png").replace(/\s+/g, '-').toLowerCase()
      let url6b = (preUrl + prodlineformat + "-"+ featArr[5] + ".png").replace(/\s+/g, '-').toLowerCase()
